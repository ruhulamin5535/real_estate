                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 col-xl-2">
                                    ...
                                    <div class="slider-range">
                                        <label>price </label>
                                        <div data-min="1000" data-max="100000" data-unit=" T.K" class="slider-range-price ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" data-value-min="1000" data-value-max="100000">
                                            <div class="ui-slider-range ui-widget-header ui-corner-all"></div>
                                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0"></span>
                                            <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0"></span>
                                        </div>
                                        <div class="range">1000tk - 100000tk</div>
