				...
				<div class="col-12">
					<div class="site-navbar">
						...
						<?php 
							...
							<li><a href="questions_user.php">Questions</a></li>
						</ul>
					</div>
				</div>
			</div>
          ...
          <div class="single-list-content">
						...
						<div class="row property-details-list">
							<div class="col-md-12 col-sm-6">
								...
								<p><i class="fa fa-check-circle-o"></i><?php echo $row['amenities1'] ?></p>
								<p><i class="fa fa-check-circle-o"></i><?php echo $row['amenities2'] ?></p>
							</div>
						</div>
