<?php
    include('indexDB.php');
    session_start();
    $loc=$city=$desc=$am=$am1=$am2=$ar=$i=$i1=$i2=$i3=$pf=$pf1=$pf2=$rent=$dep=$time='';
    $locErr=$cityErr=$descErr=$amErr=$am1Err=$am2Err=$arErr=$iErr=$pfErr=$pf1Err=$pf2Err=$rentErr=$depErr=$timeErr='';
