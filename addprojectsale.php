<?php
    include('indexDB.php');
    session_start();
    $loc=$city=$desc=$am=$am1=$am2=$ar=$i=$i1=$i2=$i3=$pf=$pf1=$pf2=$rate='';$cost=0;
    $locErr=$cityErr=$descErr=$amErr=$am1Err=$am2Err=$arErr=$iErr=$pfErr=$pf1Err=$pf2Err=$costErr=$rateErr='';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (empty($_POST["loc"])) {
      ...
      if (empty($_POST["amen1"])) {
        $am1Err = "*Amenities is required";
        $b=false;
      } else {
        $am1 = test_input($_POST["amen1"]);
      }
      if (empty($_POST["amen2"])) {
        $am2Err = "*Amenities is required";
        $b=false;
      } else {
        $am2 = test_input($_POST["amen2"]);
      }
      ...
      if (empty($_POST["p_feature"])) {
        $pfErr = "*Amenities is required";
        $b=false;
      } else {
        $pf = test_input($_POST["p_feature"]);
      }
      if (empty($_POST["p_feature1"])) {
        $pf1Err = "*Amenities is required";
        $b=false;
      } else {
        $pf1 = test_input($_POST["p_feature1"]);
      }
      if (empty($_POST["p_feature2"])) {
        $pf2Err = "*Amenities is required";
        $b=false;
      } else {
        $pf2 = test_input($_POST["p_feature2"]);
      }
  if (empty($_POST["area"])) {
...
if($b==true && isset($_POST['submit']))
{
    ...
    $q1="insert into flat(location,".$id.",city,description,amenities,area,image,image1,image2,image3,p_feature,p_feature1,p_feature2,amenities1,amenities2) values('$loc',".$_SESSION['id'].",'$city','$desc','$am',$ar,'$i','$i1','$i2','$i3','$pf','$pf1','$pf2','$am1','$am2')";
...
<tr>
<td><b>Amenities1 internet:</b></td>
<td><input type="text" name="amen1" size="30">
<span class="error"><?php echo $amErr; ?></span>
  <br><br>
</td>
</tr>
<tr>
<td><b>Amenities2 air:</b></td>
<td><input type="text" name="amen2" size="30">
<span class="error"><?php echo $amErr; ?></span>
  <br><br>
</td>
</tr>
...
<tr>
<td><b>bedroom</b></td>
<td><input type="text" name="p_feature" size="30">
<span class="error"></span>
  <br><br>
</td>
</tr>
<tr>
<td><b>bathroom</b></td>
<td><input type="text" name="p_feature1" size="30">
<span class="error"></span>
  <br><br>
</td>
</tr>
<tr>
<td><b>garages</b></td>
<td><input type="text" name="p_feature2" size="30">
<span class="error"></span>
  <br><br>
</td>
</tr>
