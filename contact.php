			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="contact_info">
						...
						<div class="contact_info_text"><p>If you want to give us any suggestions or if you have queries, you can also post us on the following addresses.</p></div>
						<div class="contact_info_content">
							<ul class="contact_info_list">
								<li>
									<div>Address:</div>
									<div>Lotus Kamal Tower Two, Level- 12, Plot: 59 & 61, Gulshan South Avenue, Gulshan-1, Dhaka-1212</div>
								</li>
								<li>
									<div>Phone:</div>
									<div>+880 2989 0044</div>
								</li>
								<li>
									<div>Email:</div>
